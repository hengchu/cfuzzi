...
# coq_makefile -f _CoqProject Logic.v Semantics.v Syntax.v VarMap.v VariableDefinitions.v 
#
...
COQLIBS?=\
  -Q "." ""\
  -R "/Users/hengchu/.opam/4.04.2/lib/coq/user-contrib/Random" Random
COQCHKLIBS?=\
  -R "." ""\
  -R "/Users/hengchu/.opam/4.04.2/lib/coq/user-contrib/Random" Random
COQDOCLIBS?=\
